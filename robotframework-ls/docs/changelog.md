...
- Added support for defining variable scopes in `VAR` statements. Supported scopes are `GLOBAL`, `SUITE`, `TEST`, `TASK` and `LOCAL` (default). Typed variable hints are planned for a future release.
